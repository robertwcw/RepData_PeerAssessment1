...
Take note that the variable **date** shall belonged to the date class vector instead of the current character class vector for which date values are stored as character string in the **activity** data set. Time-series related analysis requires that the **date** variable be transformed into formal date class vector to warrant proper analysis.
...
Missing value distribution reveals how the missing values are distributed in the data set.  
