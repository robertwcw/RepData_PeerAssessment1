...
As shown in the Boxplot (left) and histogram (right) above, least number of observations data points revolving around the average 200-step count mark affirm the unusual huge spike exhibited in the Average Daily Activity Pattern time series graph plot is the result of this data circumstance.
&nbsp;
...
5-numbers summary of imputed **activity** data set shows that missing values had been imputed with k number of nearest neighbour data values.  
...
title(main = "Number of Steps Taken Per Day", 
      ...
      cex = 1)
```
Histogram **Number of Steps Taken Per Day** plotted using imputed **activity** data set 
&nbsp;
