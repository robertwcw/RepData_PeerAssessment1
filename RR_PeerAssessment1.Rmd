...
The 5-numbers summary of 'activity' data set shows there are 2304 missing values, approx. 13.11% missing values out of the entire data set found in the 1st column named **steps** variable, whereas 2nd and 3rd columns **date** and **interval** variables are complete without missing values.
...
Histogram plotted using incomplete 'activity' data set. 
```{r}
