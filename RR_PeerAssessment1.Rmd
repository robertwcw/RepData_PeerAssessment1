...
As shown in the Boxplot (left) and histogram (right) above, least number of observation data point beyond the average 200-step count mark affirmed the unusual sharp spike exhibited in the Average Daily Activity Pattern time series graph plot.
&nbsp;
...
There is apparent difference observed in the time series plot between weekend and weekday, which activity average paces are more intense over the weekends than weekdays. The anonymous individual tends to pick up paces later at 0800 ~ 0830 for the weekends as oppose to weekdays, and wind-down paces later for the day over the weekends too. 
...
rm(filels,gr0,h,datadir,na.count,na.ratio,pal,par.default)
```
